...
namespace WebApp2.Migrations.Data
{
    ...
    [Migration("20230529112842_Comment")]
            ...
            modelBuilder.Entity("WebApp2.Models.Entities.ContactEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("841bdba3-5463-4e7a-8e81-417358463da4"),
                            Comment = "Hejsan",
                            Created = new DateTime(2023, 5, 29, 13, 28, 42, 254, DateTimeKind.Local).AddTicks(6284),
